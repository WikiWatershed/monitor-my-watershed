...
class StreamWatchODM2Adapter:
    ...
    PARAMETER_CROSSWALK = {
        ...
        "macro_plecoptera": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 1),
        "macro_ephemeroptera": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 2),
        "macro_trichoptera": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 3),
        "macro_megaloptera": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 4),
        "macro_elmidae": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 5),
        "macro_psephenidae": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 6),
        "macro_prosobranchia": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 7),
        ...
        "macro_bivalvia": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 14),
        "macro_decapoda": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 15),
        "macro_hydropsychidae": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 16),
        ...
        "macro_archaeopulmonata": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 21),
        "macro_oligochaeta": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 22),
        "macro_syrphidae": FieldConfig(8, _FloatFieldAdapter, 409, "Organism", 23),
