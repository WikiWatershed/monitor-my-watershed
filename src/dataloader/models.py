...
from dataloader.querysets import (
    AffiliationQuerySet,
...
class ObjectRelation(models.Model):
    ...
    relationship_type = models.ForeignKey(
        "RelationshipType", db_column="relationshiptypecv", on_delete=models.CASCADE
    )
...
class ExtendedResult(models.Model):
    result = models.OneToOneField(
        "Result", db_column="resultid", on_delete=models.DO_NOTHING, primary_key=True
    )
...
class Organization(ODM2Model):
    ...
    organization_type = models.ForeignKey(
        "OrganizationType", db_column="organizationtypecv", on_delete=models.CASCADE
    )
...
class Method(ODM2Model):
    ...
    annotations = models.ManyToManyField(
        "Annotation", related_name="annotated_methods", through="MethodAnnotation"
    )
...
class Action(ODM2Model):
    ...
    annotations = models.ManyToManyField(
        "Annotation", related_name="annotated_actions", through="ActionAnnotation"
    )
    extension_property_values = models.ManyToManyField(
        "ExtensionProperty",
    ...
    def __str__(self):
        return "%s %s %s" % (
            self.begin_datetime,
            self.begin_datetime_utc_offset,
            self.action_type_id,
        )
...
class Result(models.Model):
    ...
    processing_level = models.ForeignKey(
        ProcessingLevel, db_column="processinglevelid", on_delete=models.CASCADE
    )
    ...
    annotations = models.ManyToManyField(
        "Annotation", related_name="annotated_results", through="ResultAnnotation"
    )
    extension_property_values = models.ManyToManyField(
        "ExtensionProperty",
        related_name="results",
...
class EquipmentModel(models.Model):
    ...
    model_manufacturer = models.ForeignKey(
        "Organization", db_column="modelmanufacturerid", on_delete=models.CASCADE
    )
    ...
    output_variables = models.ManyToManyField(
        "Variable", related_name="instrument_models", through="InstrumentOutputVariable"
    )
    output_units = models.ManyToManyField(
        "Unit", related_name="instrument_models", through="InstrumentOutputVariable"
    )
...
class Equipment(models.Model):
    ...
    annotations = models.ManyToManyField(
        "Annotation", related_name="annotated_equipment", through="EquipmentAnnotation"
    )
...
class CalibrationReferenceEquipment(models.Model):
    ...
    equipment = models.ForeignKey(
        "Equipment", related_name="+", db_column="equipmentid", on_delete=models.CASCADE
    )
...
class EquipmentUsed(models.Model):
    bridge_id = models.AutoField(db_column="bridgeid", primary_key=True)
    action = models.ForeignKey(
        "Action", related_name="+", db_column="actionid", on_delete=models.CASCADE
    )
    equipment = models.ForeignKey(
        "Equipment", related_name="+", db_column="equipmentid", on_delete=models.CASCADE
    )
...
class ActionDirective(models.Model):
    ...
    directive = models.ForeignKey(
        "Directive", related_name="+", db_column="directiveid", on_delete=models.CASCADE
    )
...
class SpatialOffset(models.Model):
    ...
    spatial_offset_type = models.ForeignKey(
        "SpatialOffsetType", db_column="spatialoffsettypecv", on_delete=models.CASCADE
    )
    offset_1_value = models.FloatField(db_column="offset1value")
    offset_1_unit = models.ForeignKey(
        "Unit", related_name="+", db_column="offset1unitid", on_delete=models.CASCADE
    )
...
class Site(models.Model):
    ...
    spatial_reference = models.ForeignKey(
        "SpatialReference", db_column="spatialreferenceid", on_delete=models.CASCADE
    )
...
class Annotation(models.Model):
    ...
    annotation_type = models.ForeignKey(
        "AnnotationType", db_column="annotationtypecv", on_delete=models.CASCADE
    )
...
class MethodAnnotation(AnnotationBridge):
    method = models.ForeignKey(
        "Method", related_name="+", db_column="methodid", on_delete=models.CASCADE
    )
...
class DataSetResult(models.Model):
    ...
    data_set = models.ForeignKey(
        "DataSet", related_name="+", db_column="datasetid", on_delete=models.CASCADE
    )
    result = models.ForeignKey(
        "Result", related_name="+", db_column="resultid", on_delete=models.CASCADE
    )
...
class DataQuality(models.Model):
    ...
    data_quality_type = models.ForeignKey(
        "DataQualityType", db_column="dataqualitytypecv", on_delete=models.CASCADE
    )
...
class ReferenceMaterial(models.Model):
    ...
    reference_material_medium = models.ForeignKey(
        "Medium", db_column="referencematerialmediumcv", on_delete=models.CASCADE
    )
...
class ResultNormalizationValue(models.Model):
    result = models.OneToOneField(
        "Result", db_column="resultid", on_delete=models.CASCADE, primary_key=True
    )
...
class ExtensionProperty(models.Model):
    ...
    property_data_type = models.ForeignKey(
        "PropertyDataType", db_column="propertydatatypecv", on_delete=models.CASCADE
    )
...
class SamplingFeatureExtensionPropertyValue(ExtensionPropertyBridge):
    sampling_feature = models.ForeignKey(
        "SamplingFeature", db_column="samplingfeatureid", on_delete=models.CASCADE
    )
...
class ExternalIdentifierSystem(models.Model):
    ...
    external_identifier_system_description = models.CharField(
        db_column="externalidentifiersystemdescription", blank=True, max_length=500
    )
...
class ReferenceMaterialExternalIdentifier(ExternalIdentifierBridge):
    reference_material = models.ForeignKey(
        "ReferenceMaterial", db_column="referencematerialid", on_delete=models.CASCADE
    )
    ...
    reference_material_external_identifier_uri = models.CharField(
        db_column="referencematerialexternalidentifieruri", blank=True, max_length=255
    )
...
class SamplingFeatureExternalIdentifier(ExternalIdentifierBridge):
    ...
    sampling_feature_external_identifier_uri = models.CharField(
        db_column="samplingfeatureexternalidentifieruri", blank=True, max_length=255
    )
...
class SpatialReferenceExternalIdentifier(ExternalIdentifierBridge):
    ...
    spatial_reference_external_identifier_uri = models.CharField(
        db_column="spatialreferenceexternalidentifieruri", blank=True, max_length=255
    )
...
class TaxonomicClassifierExternalIdentifier(ExternalIdentifierBridge):
    ...
    taxonomic_classifier_external_identifier_uri = models.CharField(
        db_column="taxonomicclassifierexternalidentifieruri", blank=True, max_length=255
    )
...
class ResultDerivationEquation(models.Model):
    ...
    derivation_equation = models.ForeignKey(
        "DerivationEquation", db_column="derivationequationid", on_delete=models.CASCADE
    )
...
class TransectResult(
    ExtendedResult, AggregatedComponent, ZOffsetComponent, TimeIntendedComponent
):
...
class ProfileResultValue(
    ResultValue, ZOffsetComponent, QualityControlComponent, TimeAggregationComponent
):
    result = models.ForeignKey(
...
for model in classes:
    if database_manager == "sql_server.pyodbc":
        model._meta.db_table = sql_schema_fix.upper() + model._meta.db_table
    elif database_manager == "django.db.backends.postgresql_psycopg2":
